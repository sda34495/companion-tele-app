  ...
  <div className=" overflow-hidden rounded-lg bg-white ">
    ...
    <button className="flex items-center hover:bg-gray-300 justify-between w-full px-4 py-3  font-medium text-left text-gray-900">
      ...
      >
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-[#f2f2f2] border-t border-gray-200 p-5 w-full max-w-sm mx-auto">
        <button className="flex mx-auto bg-[#007cff] items-center mb-2 justify-center py-3  w-full text-white rounded-lg text-lg font-semibold">
          Become an Affiliate
        </button>
      </div>
    </div>
